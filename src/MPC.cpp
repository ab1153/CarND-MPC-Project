...
vector<double> MPC::Solve(Eigen::VectorXd x0, Eigen::VectorXd coeffs) {
  ...
  // since there is a 100ms delay, we take the actuation at 100ms, which has an
  // index of 100ms/0.05s = 2.
  vector<double> result = {solution.x[delta_start + 2],
                           solution.x[a_start + 2]};
